...
def get_memory_stat_by_col(df):
    ...
    write_to_json(".\\out3\\mem_stat_by_col_(no_optimization).json", col_stat)
...
def main():
    file_name = ".\\dataset_6\\[3]flights.csv"
    ...
    with open(".\\out3\\dtypes3.json", "w") as f:
    ...
    for chunk in pd.read_csv(file_name,
        ...
        chunk.to_csv(".\\out3\\df3.csv", mode="a", header=has_header, index=False)
        has_header = False
