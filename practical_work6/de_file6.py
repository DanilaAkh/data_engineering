...
"""
Данные взяты с сайта: https://catalog.data.gov/dataset/walkability-index1 
"""
...
def get_memory_stat_by_col(df):
    ...
    write_to_json(".\\out6\\mem_stat_by_col_(no_optimization).json", col_stat)
...
def main():
    file_name = ".\\dataset_6\\EPA_SmartLocationDatabase_V3_Jan_2021_Final.csv"
    ...
    with open(".\\out6\\dtypes6.json", "w") as f:
    ...
    for chunk in pd.read_csv(file_name,
        ...
        chunk.to_csv(".\\out6\\df6.csv", mode="a", header=has_header, index=False)
        has_header = False
