...
def get_memory_stat_by_col(df):
    ...
    write_to_json(".\\out5\\mem_stat_by_col_(no_optimization).json", col_stat)
...
def main():
    file_name = ".\\dataset_6\\[5]asteroid.zip"
    ...
    with open(".\\out5\\dtypes5.json", "w") as f:
    ...
    for chunk in pd.read_csv(file_name,
        ...
        chunk.to_csv(".\\out5\\df5.csv", mode="a", header=has_header, index=False)
        has_header = False
